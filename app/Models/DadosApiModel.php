...
class DadosApiModel extends BaseModel{
    ...
    protected $allowedFields = ['codigo', 'UnidadedeControle', 'ProdutoInspecionado', 'ProdutoFabricado', 'ProdutoLiberado', 'ProdutoemInventario', 'TipodeProduto', 'IndicacaodeLoteSerie', 'CodigodeSituacaoTributariaCST', 'ClassificacaoFiscal', 'GrupodeProduto'];
