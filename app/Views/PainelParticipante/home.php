...
<div class="container px-0">
    <?php if($imprimirTermo){ ?>
    <div class="row">
        <div class="col-12 col-md-12">
            <div class="card box-shadow-0">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-3">Atenção: Termo de Uso</h4>
                        <div class="alert alert-danger mg-b-0 mt-3 rounded-lg" role="alert">
                            Para usar o espaço, é obrigatório apresentar o <b>Termo de Uso</b> preenchido e assinado pelo responsável no momento do atendimento. Sem esse documento, não será possível liberar o acesso ao espaço.
                            <br>
                            <a href="<?= base_url('PainelParticipante/imprimirTermo') ;?>" class="btn btn-primary mt-4">Imprimir Termo</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card box-shadow-0">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center justify-content-end">
                <a href="<?php echo base_url('PainelParticipante/inscricoes'); ?>" class="btn btn-outline-secondary btn-sm">Ver todas</a>
            </div>
        </div>
        <div class="card-body pt-0">
            <div class="table-responsive">
...
<div class="row">
    <div class="col-12 col-md-12">
        <div class="card box-shadow-0">
            ...
            <div class="card-body pt-0" id="proximosEventos">
