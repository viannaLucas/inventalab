    ...
    <div class="container-fluid">
        ...
        <div class="">
            <div class="responsive-logo">
                <a href="<?php echo base_url('PainelParticipante/home'); ?>"><img src="<?php echo base_url('assets/img/brand/logo.png'); ?>" class="logo-1" alt="logo"></a>
                <a href="<?php echo base_url('PainelParticipante/home'); ?>"><img src="<?php echo base_url('assets/img/brand/logo-white.png'); ?>" class="dark-logo-1" alt="logo"></a>
                <a href="<?php echo base_url('PainelParticipante/home'); ?>"><img src="<?php echo base_url('assets/img/brand/favicon.png'); ?>" class="logo-2" alt="logo"></a>
                <a href="<?php echo base_url('PainelParticipante/home'); ?>"><img src="<?php echo base_url('assets/img/brand/favicon-white.png'); ?>" class="dark-logo-2" alt="logo"></a>
            </div>
        </div>
