            ...
            <section class="auth-card">
                ...
                <div class="auth-form">
                    <div class="auth-form-header auth-stagger delay-1">
                        <div class="auth-kicker">Participante</div>
                        <h2 class="auth-form-title">Recuperar senha</h2>
                        <p class="auth-form-subtitle">Informe o e-mail cadastrado.</p>
                    </div>
                    <?php
                    ...
                    ?>
                    <form action="<?= base_url('PainelParticipante/doRecuperarSenha'); ?>" method="post">
