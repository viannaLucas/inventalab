...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Pesquisa de Satisfação</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Alterar</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="container px-0 ">
    <div class="card  box-shadow-0">
        ...
        <div class="card-body pt-0">
            <form id='formAlterar' action="<?PHP echo base_url('PesquisaSatisfacao/doAlterar'); ?>" class="needs-validation" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input class="form-control maskInteiro" name="Participante_id" id="Participante_id" type="text" value="<?= esc($pesquisasatisfacao->Participante_id, 'attr') ?>">
                    </div>                    
                    <div class="form-group col-12 col-md-6">
