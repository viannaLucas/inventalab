            ...
            <form id='formCadastrar' action="<?PHP echo base_url('PesquisaSatisfacao/doCadastrar'); ?>" class="needs-validation" method="post" enctype="multipart/form-data" >
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input class="form-control maskInteiro" name="Participante_id" id="Participante_id" type="text" value="<?= old('Participante_id') ?>">
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Resposta 1</label> 
                        <input class="form-control maskInteiro" name="resposta1" id="resposta1" type="text" value="<?= old('resposta1') ?>">
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Resposta 2</label> 
                        <input class="form-control maskInteiro" name="resposta2" id="resposta2" type="text" value="<?= old('resposta2') ?>">
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Resposta 3</label> 
                        <input class="form-control maskInteiro" name="resposta3" id="resposta3" type="text" value="<?= old('resposta3') ?>">
                    </div>                    
                    <div class="form-group col-12 ">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Resposta 4</label> 
                        <textarea name="resposta4" id="resposta4" class="form-control" placeholder="" rows="3"><?= old('resposta4') ?></textarea>
                    </div>                    
                    <div class="form-group col-12 ">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Resposta 5</label> 
                        <textarea name="resposta5" id="resposta5" class="form-control" placeholder="" rows="3"><?= old('resposta5') ?></textarea>
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Data Resposta</label> 
                        <input class="form-control maskData" name="dataResposta" id="dataResposta" type="text" value="<?= old('dataResposta') ?>">
                    </div>                                        
