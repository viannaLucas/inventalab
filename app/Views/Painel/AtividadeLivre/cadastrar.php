...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Atividade Livre</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Cadastrar</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="container px-0 ">
    <div class="card  box-shadow-0">
        ...
        <div class="card-body pt-0">
            <form id='formCadastrar' action="<?PHP echo base_url('AtividadeLivre/doCadastrar'); ?>" class="needs-validation" method="post" enctype="multipart/form-data" >
                <div class="form-row">
                    ...
                    <div class="form-row px-2">
                        <div class="form-group col-auto">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" name="atividadelivrerecurso_RecursoTrabalho_id_Text" id="atividadelivrerecurso_RecursoTrabalho_id_Text" type="text" disabled="true" onclick="$('#addonSearchatividadelivrerecurso_RecursoTrabalho_id').click()" value="<?= old('atividadelivrerecurso_RecursoTrabalho_id_Text'); ?>"/>
                                <div class="input-group-append">
                                ...
                                <input class="d-none" name="atividadelivrerecurso_RecursoTrabalho_id" id="atividadelivrerecurso_RecursoTrabalho_id" type="text" value="<?= old('atividadelivrerecurso_RecursoTrabalho_id'); ?>" />
                            </div>
                        </div>                        
                        <div class="form-group col-auto">
...
<script>
    ...
    function addAtividadeLivreRecurso() {
        ...
        html = html.replaceAll('{_RecursoTrabalho_id_}', $('#atividadelivrerecurso_RecursoTrabalho_id').val());
        html = html.replaceAll('{_RecursoTrabalho_id_Text_}', $('#atividadelivrerecurso_RecursoTrabalho_id_Text').val());
