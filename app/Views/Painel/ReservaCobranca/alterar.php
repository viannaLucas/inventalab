...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Reserva Cobrança</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Alterar</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="container px-0 ">
    <div class="card  box-shadow-0">
        ...
        <div class="card-body pt-0">
            <form id='formAlterar' action="<?PHP echo base_url('ReservaCobranca/doAlterar'); ?>" class="needs-validation" method="post" enctype="multipart/form-data" >
                <input type="hidden" name="id" value="<?= $reservacobranca->id ?>" />
                <div class="form-row">
                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Reserva</label> 
                        <div class="input-group">
                            <input class="form-control" name="Reserva_id_Text" id="Reserva_id_Text" type="text" disabled="true" onclick="$('#addonSearchReserva_id').click()" value="<?= $reservacobranca->getReserva()->horaInicio ?>"/>
                            ...
                            <input class="d-none" name="Reserva_id" id="Reserva_id" type="text" value="<?= $reservacobranca->Reserva_id ?>" />
                        </div>
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Cobrança</label> 
                        <div class="input-group">
                            <input class="form-control" name="Cobranca_id_Text" id="Cobranca_id_Text" type="text" disabled="true" onclick="$('#addonSearchCobranca_id').click()" value="<?= $reservacobranca->getCobranca()->id ?>"/>
                            <div class="input-group-append">
                            ...
                            <input class="d-none" name="Cobranca_id" id="Cobranca_id" type="text" value="<?= $reservacobranca->Cobranca_id ?>" />
                        </div>
                    </div>                                        
