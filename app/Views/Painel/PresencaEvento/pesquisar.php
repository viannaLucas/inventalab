...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Presença Evento</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Pesquisa</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="container px-0 ">
    <div class="card  box-shadow-0">
        ...
        <div class="card-body pt-0">
            <form id='formPesquisa' action="<?PHP echo base_url('PresencaEvento/doPesquisar'); ?>" class="needs-validation" method="GET" enctype="multipart/form-data" >
                <div class="form-row">
                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Participante Evento</label> 
                        <div class="input-group">
                            <input class="form-control" name="ParticipanteEvento_id_Text" id="ParticipanteEvento_id_Text" type="text" disabled="true" onclick="$('#addonSearchParticipanteEvento_id').click()"/>
                            ...
                            <input class="d-none" name="ParticipanteEvento_id" id="ParticipanteEvento_id" type="text" />
                        </div>
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Controle Presenta</label> 
                        <div class="input-group">
                            <input class="form-control" name="ControlePresenta_id_Text" id="ControlePresenta_id_Text" type="text" disabled="true" onclick="$('#addonSearchControlePresenta_id').click()"/>
                            <div class="input-group-append">
                            ...
                            <input class="d-none" name="ControlePresenta_id" id="ControlePresenta_id" type="text" />
                        </div>
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600" for="presente">Presente</label> 
                        <select class="form-control select2" name="presente[]" id="presente" multiple="multiple">
