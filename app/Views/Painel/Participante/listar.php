...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Participante</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Listar</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <?PHP foreach ($vParticipante as $i) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <div data-href="<?php echo base_url('Participante/excluir/' . $i->id); ?>" class="btn btn-danger btn-sm btnExcluirLista">
