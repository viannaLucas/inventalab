...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Recurso Trabalho</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Alterar</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <form id='formAlterar' action="<?PHP echo base_url('RecursoTrabalho/doAlterar'); ?>" class="needs-validation" method="post" enctype="multipart/form-data" >
                ...
                <fieldset class="border rounded-10 m-0 mb-3 p-2 w-100">
                    ...
                    <div class="form-row px-2"><div class="form-group col-auto">
                            <label class="main-content-label tx-11 tx-medium tx-gray-600">Descrição</label> 
                            <input class="form-control" name="garantia_descricao" id="garantia_descricao" type="text" maxlength="200" value="">
                        </div>                        
                        ...
                        <div class="form-group col-auto">
                            ...
                            <input class="form-control maskData" name="garantia_dataInicio" id="garantia_dataInicio" type="text" value="">
                        </div>                        
                        <div class="form-group col-auto">
                            <label class="main-content-label tx-11 tx-medium tx-gray-600">Data Fim</label> 
                            <input class="form-control maskData" name="garantia_dataFim" id="garantia_dataFim" type="text" value="">
                        </div>                        
                        <div class="form-group col-auto">
...
<script>
    ...
    var validator = $("#formAlterar").validate({
        ...
        rules: {
            ...
            foto: {
                required: $('.dropify').data("defaultFile") == '',
    ...
    function addGarantia() {
        ...
        let dados = {};
        dados.descricao = $('#garantia_descricao').val();
        dados.tipo = $('#garantia_tipo').val();
        dados.dataInicio = $('#garantia_dataInicio').val();
        dados.dataFim = $('#garantia_dataFim').val();
            
        insertRowGarantia(dados);
    ...
    function insertRowGarantia(dados){
        ...
        html = html.replaceAll('{_tipo_}', dados.tipo);
        html = html.replaceAll('{_tipo_Text_}', $("#garantia_tipo option[value="+dados.tipo+"]").text());
        html = html.replaceAll('{_dataInicio_}', dados.dataInicio);
        html = html.replaceAll('{_dataFim_}', dados.dataFim);
        $('#listTableGarantia tbody').append(html);
        
        indexRowGarantia++;
        $(".msgEmptyListGarantia").hide();
    }
