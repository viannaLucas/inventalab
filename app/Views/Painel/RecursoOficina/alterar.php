...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Recurso Oficina</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Alterar</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="container px-0 ">
    <div class="card  box-shadow-0">
        ...
        <div class="card-body pt-0">
            <form id='formAlterar' action="<?PHP echo base_url('RecursoOficina/doAlterar'); ?>" class="needs-validation" method="post" enctype="multipart/form-data" >
                <input type="hidden" name="id" value="<?= $recursooficina->id ?>" />
                <div class="form-row">
                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Recurso Trabalho</label> 
                        <div class="input-group">
                            <input class="form-control" name="RecursoTrabalho_id_Text" id="RecursoTrabalho_id_Text" type="text" disabled="true" onclick="$('#addonSearchRecursoTrabalho_id').click()" value="<?= $recursooficina->getRecursoTrabalho()->nome ?>"/>
                            ...
                            <input class="d-none" name="RecursoTrabalho_id" id="RecursoTrabalho_id" type="text" value="<?= $recursooficina->RecursoTrabalho_id ?>" />
                        </div>
                    </div>                    
                    <div class="form-group col-12 col-md-6">
                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Oficina Temática</label> 
                        <div class="input-group">
                            <input class="form-control" name="OficinaTematica_id_Text" id="OficinaTematica_id_Text" type="text" disabled="true" onclick="$('#addonSearchOficinaTematica_id').click()" value="<?= $recursooficina->getOficinaTematica()->nome ?>"/>
                            <div class="input-group-append">
                            ...
                            <input class="d-none" name="OficinaTematica_id" id="OficinaTematica_id" type="text" value="<?= $recursooficina->OficinaTematica_id ?>" />
                        </div>
                    </div>                                        
...
<script>
    ...
    var validator = $("#formAlterar").validate({
        ...
        rules: {
            ...
            recursooficina_OficinaTematica_id: {
                required: true,
            },
        }
    });
