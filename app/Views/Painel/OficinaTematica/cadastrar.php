...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Oficina Temática</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Cadastrar</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="container px-0 ">
    <div class="card  box-shadow-0">
        ...
        <div class="card-body pt-0">
            <form id='formCadastrar' action="<?PHP echo base_url('OficinaTematica/doCadastrar'); ?>" class="needs-validation" method="post" enctype="multipart/form-data">
                <div class="form-row">
                ...
                <fieldset class="border rounded-10 m-0 mb-3 p-2 w-100">
                    <div class="border-bottom mx-n1 mb-3">
                        <h4 class="px-2">Lista de Arquivo da Oficina</h4>
                    </div>
...
<script>
    ...
    function addRecursoOficina() {
        ...
        html = html.replaceAll('{_RecursoTrabalho_id_}', $('#recursooficina_RecursoTrabalho_id').val());
        html = html.replaceAll('{_RecursoTrabalho_id_Text_}', $('#recursooficina_RecursoTrabalho_id_Text').val());
