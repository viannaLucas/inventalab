                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <div class="input-group">
                            <input class="form-control" name="Participante_id_Text" id="Participante_id_Text" type="text" readonly="true" value="<?= esc($cobranca->getParticipante()->nome, 'attr') ?>" />
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input class="form-control maskData" name="data" id="data" type="text" value="<?= esc($cobranca->data, 'attr') ?>" readonly="true">
                    </div>
                    <div class="form-group col-12 col-md-6">
