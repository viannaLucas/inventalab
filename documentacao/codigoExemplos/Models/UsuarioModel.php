...
class UsuarioModel extends BaseModel {
    ...
    private const SESSION_NAME = 'sessao_f360_sistemamodelo';
    ...
    protected $validationRules = [
        ...
        'login' => ['label'=> 'Login', 'rules'=>'required|min_length[5]|alpha_numeric_punct|is_unique[Usuario.login,id,{id}]'],
    ...
    protected $validationRulesFiles = [
        ...
        'senha' => ['label'=> 'Senha', 'rules'=>'permit_empty|min_length[5]'],
    ...
    protected $beforeUpdate = ['protecaoAtivo'];
     ...
     * @param type $planPW senha do usuário em texto puro
